...
<h3><?php echo esc_html_e('Include categories')?></h3>
  ...
  <div class="include-categoty-settings seg-categories">

  </div>
  <div class="seg-include cat-tree">
</div>
<h3><?php echo esc_html_e('Exclude categories')?></h3>

  <div class="exclude-categoty-settings seg-categories">

  </div>
  <div class="seg-exclude cat-tree">
</div>
</div>
<div class="seg-view-setting" >
  <div class="seg-view-item left-column"><label for="excerpt-suffix"><?php echo esc_html_e('Excerpt suffix')?></label>
  <input type="text" id="excerpt-suffix" class="setting" name="" value="" />
</div><div class="seg-view-item rigth-column">
  ...
  <div class="generate-button-container"><button id="seg-generate" type="button" name="generate"><?php echo esc_html_e('Generate excerpts') ?></button></div>
</div>
